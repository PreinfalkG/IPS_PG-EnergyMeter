...
trait MECMETER_HELPER {
    ...
    const MECM_CONIG_ARR = array(
        ...
        'PFA' => ['Leistungsfaktor L1', VARIABLETYPE_FLOAT, '', 1, 2, 'PFx', 'Leistungsfaktor', 50, 36, true],
        'PFB' => ['Leistungsfaktor L2', VARIABLETYPE_FLOAT, '', 1, 2, 'PFx', 'Leistungsfaktor', 50, 37, true],
        'PFC' => ['Leistungsfaktor L3', VARIABLETYPE_FLOAT, '', 1, 2, 'PFx', 'Leistungsfaktor', 50, 38, true],
        'PFT' => ['Leistungsfaktor Total', VARIABLETYPE_FLOAT, '', 1, 2, 'PFx', 'Leistungsfaktor', 50, 39, true],
